/**
 * Base HTML layout template for all pages.
 */
...
/**
 * Generate the base HTML layout wrapping page content.
 */
          ...
          .map(([mod, docs]) => {
            const docsLinks = docs
              .map((d) => {
                ...
                return `<a href="${escapeHtml(href)}" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white pl-6">${escapeHtml(label)}</a>`;
              })
              .join("");
            return `
          <div class="mt-1">
            <span class="block px-4 py-1 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">${escapeHtml(mod)}</span>
            ${docsLinks}
          </div>`;
          })
          .join("")
      ...
      <div class="flex justify-between h-16">
        <div class="flex items-center">
          <div class="flex-shrink-0 flex items-center gap-3">
            <img src="${prefix}assets/logo.png" alt="Docs Kit MCP" class="h-10 w-10" />
  ...
  <div class="flex min-h-[calc(100vh-4rem)] overflow-x-hidden">
    <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 hidden md:block flex-shrink-0">
      <div class="px-6 pt-2 pb-6 sticky max-h-[calc(100vh-4rem)] overflow-y-auto">
        ...
        <nav class="space-y-1">
          <a href="${prefix}docs.html" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">All Docs</a>
          ${docsMenuHtml}
        </nav>

        <h3 class="px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mt-8 mb-2">Health</h3>
        <nav class="space-y-1">
          <a href="${prefix}deprecated.html" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Deprecated</a>
          <a href="${prefix}governance.html" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Violations</a>
          <a href="${prefix}index.html#high-impact-symbols" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">High impact</a>
        </nav>

        <h3 class="px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mt-8 mb-2">Quick Links</h3>
        <nav class="space-y-1">
          <a href="${prefix}index.html#code-metrics" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Code metrics</a>
          <a href="${prefix}index.html#architecture-overview" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Architecture</a>
          <a href="${prefix}index.html#architecture-layers" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Layers</a>
          <a href="${prefix}index.html#top-complex-symbols" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Complexity</a>
          <a href="${prefix}relationships.html" class="block px-4 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">All Relationships</a>
        </nav>
      </div>
    </aside>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a href="${prefix}index.html" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">Documentation Home</a>
            </li>
            <li>
              <a href="${prefix}patterns.html" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">Patterns & Architecture</a>
            </li>
            <li>
              <a href="${prefix}governance.html" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">Code Quality</a>
            </li>
          </ul>
        </div>
      ...
      <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
          <p class="text-sm text-gray-500 dark:text-gray-400">
            © ${new Date().getFullYear()} Docs Kit MCP. Living connection between code & knowledge.
          </p>
